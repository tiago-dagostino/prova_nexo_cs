...
namespace ProjetoModeloDDD.MVC.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public ActionResult PesquisaNome(string searchString)
        {
            var produtoViewModel =
                Mapper.Map<IEnumerable<Produto>, IEnumerable<ProdutoViewModel>>(_produtoApp.BuscarPorNome(searchString));
            return View(produtoViewModel);
        }
    }
}
